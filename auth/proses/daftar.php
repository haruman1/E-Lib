...
if (empty($_POST['register'])) {
  ...
  echo '<script>alert("alert yang pertama")</script>';
} else {
  if (!empty($_POST['register'] == 'register')) {
    ...
    if (!empty($insert_user)) {
      ...
      FilePenting::add_with_type(
        'Gagal mendaftar, silahkan coba lagi 2',
        'danger'
      );
    }
  } else {
    ...
    echo '<script>alert("alert yang 2")</script>';
  }
}
                            ...
                            <tr>
                                <td bgcolor='#ffffff' align='center' style='padding: 20px 30px 60px 30px;'>
                                    <table border='0' cellspacing='0' cellpadding='0'>
                                        <tr>
                                            <td align='center' style='border-radius: 3px;' bgcolor='#FFA73B'><a href='localhost/e-book/mail/verif.php?email=" .
    $email_user .
    '&token=' .
    $token .
