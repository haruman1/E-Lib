...
<head>
    ...
    <link rel="stylesheet" href="./assets/styles/css/common/BorrowPage.css" />
    <link rel="stylesheet" href="./assets/styles/css/BorrowPage.css">
        ...
        <section id="product" class="product container">
            ...
            <div class="left-column">
                <ul class="breadcrumb">
                    ...
                    <li><a href="CategoryBook.html">Buku</a></li>
                    <li>The Catcher in The Rye</li>
                </ul>
                <img id="imageBuku" src="assets/image/buku1.jpg" alt="" style="height: 500px;">
            </div>
            ...
            <div class="right-column">
                ...
                <div class="product-configuration">
                    ...
                    <div class="sisi-config">
                        ...
                        <div class="sisi-pilih">
                            <button onclick="document.getElementById('imageBuku').src='assets/image/buku1.jpg'">Depan</button>
                            <button onclick="document.getElementById('imageBuku').src='assets/image/buku1Belakang.jpg'">Belakang</button>
                        </div>
                ...
                <!-- Pinjam / Baca -->
                <div>
                    <a href="BorrowPageDetail.html" class="pinjam-btn">Pinjam</a>
                    <a href="login.html" class="baca-btn">Sign in untuk membaca</a>
                </div>

                <div class= "daftar">
                    <p style="display:inline-block;padding-top: 10px;">Atau lakukan </p>
                    <a href="registrasi.html" style="color: #358ED7;">Registrasi</a>
                </div>
            </div>
        </section>
