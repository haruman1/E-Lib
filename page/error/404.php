...
<!DOCTYPE html>
<html lang="en">
<link rel="stylesheet" href="<?php echo $_ENV['LINK_WEB'] ?>assets/styles/css/common/404.css?v=1.0.0">
...
<body>
    ...
    <script src="<?php echo $_ENV['LINK_WEB'] ?>assets/styles/js/404.js?v=1.0.0"></script>
</body>
