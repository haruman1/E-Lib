...
<head>
    ...
    <title><?= $_ENV['NAMA_WEB']?> - <?= $data['judulbuku']?></title>
                    ...
                    <div class="col-6">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 d-flex align-items-center">
                              ...
                              <li class="breadcrumb-item active" aria-current="page"><?= $data['judulbuku']?></li>
                            </ol>
                          </nav>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title"><?= $data['judulbuku'] ?></h4>
                            </div>
                                <div class="comment-widgets scrollable">
                                <!-- Comment Row -->
                                <div class="d-flex flex-row comment-row m-t-0">
                                    <div class="p-2"><img src="../../assets/image/<?= $data['cover_buku'];?>" alt="user" width="150"
                                            ></div>
